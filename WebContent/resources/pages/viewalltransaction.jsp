...
<head>
    ...
    <script src="${pageContext.request.contextPath}/resources/dist/js/sb-admin-2.js"></script>
      <script src="${pageContext.request.contextPath}/resources/js/viewalltransaction.js"></script>
                                                       ...
                                                       <table class="table table-striped table-bordered table-hover" id="tabledata">
                                                              <thead>
                                                                                         <tr>
																								...
																								<th style="background-color: #0FA0A7;">Transaction Id</th>
																							    <th style="background-color: #0FA0A7;">User Name</th>
																								<th style="background-color: #0FA0A7;">Product Name</th>
																								<th style="background-color: #0FA0A7;">Quantity</th>
																								<!-- <th>effectiveDate</th> -->
																									<!-- <th>endDate</th> -->
