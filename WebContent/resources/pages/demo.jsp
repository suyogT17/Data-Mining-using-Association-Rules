            ...
            <div class="container-fluid">
                <div class="row">
                   <!--  Start designing your Html body from here -->
                    <form:form action="postupdateuserfromother.html" modelAttribute="updateDetail"
									method="post">
						firstName:
						<form:input id="firstName" path="firstName" size="20" readonly="true"/>
						
						name:
						<form:input id="name" path="name" size="20" readonly="true"/>				
						Country:
						
						<form:select path="email" items="${list1}"></form:select>
