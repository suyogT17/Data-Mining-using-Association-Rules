...
<head>
    ...
    $(document).ready(function(){
    	$("#dot2").css({"background-color" : "#67A92C"});
...
<!-- Page Content -->
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Bill Summary
                    <small></small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="home.html">Home</a>
                    </li>
                    <li class="active">Bill Summary</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
                        ...
                        <div class="panel-body">
                        	<div class="row bs-wizard" style="border-bottom:0;">
					                ...
					                <div class="col-xs-3 bs-wizard-step complete " id="step1">
					                  ...
					                  <div class="bs-wizard-info text-center" id="text1">Order Summary of Your Purchased</div>
					                </div>
					                
					                <div class="col-xs-3 bs-wizard-step active " id="step2"><!-- complete -->
					                  <div class="text-center bs-wizard-stepnum">Step 2</div>
					                  <div class="progress"><div class="progress-bar"></div></div>
					                  <a href="#" class="bs-wizard-dot" id="dot2"></a>
					                  <div class="bs-wizard-info text-center" id="text2"><b>Bill Summary for Your Order</b></div>
					                </div>
							...
							<div class="row">
								...
								<form:form method="post" action="next2.html" modelAttribute="orderList">
	                                <table class="table">
	                                    <thead>
	                                        <tr>
	                                            <th>ID</th>
	                                    ...
	                                    <tbody>
	                                     <c:forEach items="${orderList.cartProductList}" var="p" varStatus="status">
	                                        <tr class="success">
	                                            ...
	                                            <td><input type="hidden" name="cartProductList[${status.index}].quantity" value="${p.quantity}"/>${p.quantity}</td>
	                                        ...
	                                        <tr class ="info">
	                                        	...
	                                        	<td></td>
	                                        	<td>TOTAL BILL</td>
	                                        	<td><input type="hidden" name="orderList.totalprice" value="${orderList.totalprice}"/>Rs.${orderList.totalprice}</td>
	                                        </tr>
	                                        <tr>
	                                        	<td></td>
	                                        	<td></td>
	                                        	<td></td>
		                                			...
		                                			<td><button type="submit" name="next2" class="btn btn-primary btn-circle btn-lg">
		                               	 				<i class="fa fa-arrow-circle-right "></i>
		                                			</button>       <button type="submit" name="previous1" id="leftbutton"class="btn btn-primary btn-circle btn-lg">
