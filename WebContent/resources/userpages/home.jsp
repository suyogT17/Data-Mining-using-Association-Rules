...
<head>
    ...
    <!-- Custom CSS -->
    <link href="${pageContext.request.contextPath}/resources/dist/css/modern-business.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="${pageContext.request.contextPath}/resources/dist/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
        ...
        <div class="row">
        	<div class="row h1 page-header">
        		...
        		<div class="col-md-4">
        			<div class="input-group">
                        <input type="text" class="form-control" placeholder="search your product here..">
            ...
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3>LG<br>
                            <small>No 1 Refridgerator</small>
                        </h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste saepe et quisquam nesciunt maxime.</p>
                        <ul class="list-inline">
                            <li><a href="#"><i class="fa fa-2x fa-shopping-cart cart" id="1"></i></a>
                            </li>
                            <li><a href="#"><i class="fa fa-2x fa-eye "></i></a>
                            </li>
